...
import RestoreFilesButton from '@/Components/app/RestoreFilesButton';
import DeleteForeverButton from '@/Components/app/DeleteForeverButton';
                ...
                {Object.values(selectedFiles).reduce((pre, file) => pre + (file === true ? 1 : 0), 0) === 0 ? (
                    ...
                    <div className="bg-slate-100 w-full h-full inline-flex items-center justify-between mb-3 rounded-t-3xl">
                        <div className="flex items-center">
                            <RestoreFilesButton selectedIds={selectedFileIds} onRestore={clearSelections} />
                            <DeleteForeverButton deleteIds={selectedFileIds} onDelete={clearSelections} />
                        </div>
                        <div className="flex items-center">
                            <button
